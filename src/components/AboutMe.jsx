  ...
  return (
    <div id='about' className='about'>
      ...
      <p className="about--info">
        <li>🎓 I'm a Graduate of Bachelors of Technology in Information Technology at
        MAKAUT University.</li>
        ...
        <li>🎮 Outside coding, I love watching movies, reading books and exploring new places.</li>
      </p>
      ...
      <div className="about--button">
        <button className='about--button--resume'>
          ...
          <a href="https://drive.google.com/file/d/16PDvp9JQ-cQc9IS26EyeuG7zcwznbI9T/view?usp=sharing" target="_blank">
